...
arena_lib.on_death("murder", function(arena, p_name)
    ...
    minetest.after(1, function()
        ...
        if arena.murderer == p_name then
            arena_lib.send_message_players_in_arena(arena, murder.T("The murderer has been killed by") .. " " .. minetest.colorize("#f9a31b", arena.cop) .. ", " .. murder.T("victims won the game!"))
            arena.timer = 0
            arena.murderer = ""
        ...
        elseif arena_lib.get_arena_players_count(arena) == 2 then
            arena_lib.send_message_players_in_arena(arena, minetest.colorize("#f9a31b", arena.murderer) .. " " .. murder.T("the murderer won!"))
            arena.murderer = ""
            arena.timer = 0
